...
def classify_safety(message: str) -> SafetyResult:
    ...
    self_harm_patterns = [
        ...
        r"\b(no quiero existir|ojala no despertar|ojala no me despierte|no despertar nunca|desearia no despertar)\b",
        ...
        r"\b(me quiero|quiero|voy a|me voy a|pienso|estoy pensando en)\b.*\b(hacerme dano|danarme|autolesionarme|cortar|hacer cortes|hacerme cortes|cortarme|cortarme las venas|abrirme las venas|rajarme|rajarme las muñecas|rajarme las munecas|cortar las venas|ahorcarme|colgarme|dispararme|quemarme)",
        ...
        r"\b(desaparecer para siempre|acabar con todo|terminar con todo|acabar con esto)\b",
    ...
    overdose_patterns = [
        ...
        r"\b(tomar|tomarme|ingerir|tragar|tragarme)\b.*\b\d+\b.*\b(pastillas|medicamentos|paracetamol|ibuprofeno|ansioliticos|antidepresivos)",
        r"\b(beber|beberme|tomar|tomarme|ingerir|tragar|tragarme)\b.*\b(lejia|cloro|veneno|raticida|amoniaco|gasolina|alcohol de quemar|anticongelante)",
    ...
    harm_to_others_patterns = [
        ...
        r"\b(voy a pegarle|quiero pegarle|voy a darle una paliza|quiero darle una paliza)\b.*\b(a mi|a alguien|a mi hermano|a mi hermana|a mi madre|a mi padre|a mi pareja|a mi familia|a mis vecinos|a mi jefe|a un companero|a una persona)",
    ...
    delusion_paranoia_patterns = [
        ...
        r"\b(me controlan la mente|me leen la mente|leen mis pensamientos|control mental|me controlan por el movil|me controla el movil|el movil me controla|mi movil me controla)",
    ...
    psychotic_patterns = [
        ...
        r"\b(la tele|la television|la tv|la radio)\b.*\b(me habla|me manda mensajes|me envia mensajes|me envia señales|me envia senales)",
    ]
    ...
    medical_patterns = [
        r"\b(dejar|dejo|voy a dejar|suspender|suspendo|quitar|quitarme|dejar de tomar|dejo de tomar)\b.*\b(medicacion|medicamento|pastillas|antidepresivos|ansioliticos|tratamiento)",
